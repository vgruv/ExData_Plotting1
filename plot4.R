...
# 4 graphs in one PNG file
par(mfrow = c(2,2))

plot(HH_power_use$Date.Time, HH_power_use$Global_active_power,
     type = "l",
     ylab = "Global Active power",
     xlab = "",
     col = "black")
plot(HH_power_use$Date.Time, HH_power_use$Voltage,
     ylab = "Voltage",
     xlab = "datetime",
     type = "l")
plot(HH_power_use$Date.Time, HH_power_use$Sub_metering_1, 
     type = "l",
...
plot(HH_power_use$Date.Time, HH_power_use$Global_reactive_power, 
     type = "l",
